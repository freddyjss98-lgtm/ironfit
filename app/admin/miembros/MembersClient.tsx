...
function exportMembers(rows: Member[], filename: string) {
  downloadCSV(
    filename,
    ["Nombre","Cédula","Teléfono","Email","Cumpleaños","Género","Fecha Inscripción","Estado","Plan","Membresía Desde","Membresía Hasta","Días Restantes"],
    rows.map((r) => [
      r.full_name,
      r.cedula ?? "",
      r.phone,
    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
        ...
        <div className="flex gap-2 shrink-0 flex-wrap">
          ...
          <button
            onClick={() => exportMembers(filtered, "usuarios.csv")}
